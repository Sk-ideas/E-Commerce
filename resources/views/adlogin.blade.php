...
<section class="signup">
        ...
        <h2 class="form-title">Login</h2>
            <form method="POST" action="/adlog">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="adminid" class="form-input" id="adminid" placeholder="Your ADMINID"  value= "{{old('adminid')}}"><spam style="color: red">{{$errors->first('adminidid')}}</spam><br>
                </div>
                <div class="form-group">
   ...
   <input type= "submit">
            ...
            <p class="loginhere">
                        You don't an account ? <a href="/asminreg" class="loginhere-link">sign up</a>
                    </p>
                    </div>
            </div>
        </section>
